...
<img width="432" height="40" alt="image" src="https://github.com/user-attachments/assets/9c8b92c5-840d-41c4-ab2a-54ce9f1e6651" />
...
При применении манифеста можно отбросить флаг **-n** с названием **namespace**, так как мы сделали наш namespace основным в предыдущем задании.
...
- Rollback критически важен, когда новое обновление содержит ошибку. Важно быстро откатиться к стабильной версии.
...
Я выбрал вариант фиксации попадания запросов на разные pod'ы через логи, потому что:
